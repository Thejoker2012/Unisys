...
<body>
	<h3><font color="blue">Deleta Produto</font></h3><hr>
	...
	<form action="deletaProduto" method="post">
		...
		<table align="center">
			...
			<tr><td>Produto bloqueado:</td>
				<td><input type="radio" name="produto.bloqueado" value="S" <%=(_bloqueado=="S")?"checked":""%>>Sim &nbsp;&nbsp; 
					<input type="radio" name="produto.bloqueado" value="N" <%=(_bloqueado=="N")?"checked":""%>>Não </td></tr>  
